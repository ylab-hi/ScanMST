...
class Rescuer:
    ...
    def __init__(self, bam_file: str, mapq: int, soft_len: int, mismatch: int, align_frac: float,
                 align_len: int, average_read_depth: int) -> None: ...

    def __repr__(self) -> str: ...

    @staticmethod
    def calculate_sr(chrom: str, start: int, end: int, mode: int, strand: typing.Optional[str], read_start: int,
