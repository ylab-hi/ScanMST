...
class BamScanner:
    ...
    def scan_bam(self):
        ...
        if self.parallel == 1:
            ...
            temp_dirname = self.output.parent.joinpath(f"temp_{temp_id}")
            temp_dirname.mkdir()
            temp_output = temp_dirname.joinpath(self.output.name)
            ...
            merge_cmd = f"samtools merge {self.output} {temp_dirname}/*.bam"
