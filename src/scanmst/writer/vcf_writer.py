...
class VCFWriter(Writer):
    ...
    description: ClassVar[dict[str, str]] = {
        ...
        "SVEND": "End position of the link",  # change to SVEND in order to meet vcf standard
        ...
        "SEGMENT1": "ID for source transcript segment",  # Given multiple transcripts, there may be multiple segments
        "SEGMENT2": "ID for target transcript segment",
        "TRANSCRIPT_ID": "Transcript ID",
        "GENE_ID": "Gene ID",
        "SR_ID": "Support read ID",
        "SVMETHOD": "Type of approach used to detect SV",
        "STRAND1": "Strand for segment1",
        "STRAND2": "Strand for segment2",
