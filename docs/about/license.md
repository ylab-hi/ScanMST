...
The complete GNU GPLv3 text is available in the [LICENSE](https://github.com/ylab-hi/ScanMST/blob/main/LICENSE) file in the repository.
...
This documentation provides a summary of the GNU General Public License v3.0 for informational purposes only. It is not legal advice. For full legal terms, refer to the [official license text](https://www.gnu.org/licenses/gpl-3.0.html).
